...
function exercise() {
	...
	this.recordingFinishedListener = function(recFilename) {
		...
		mform.elements["data2"].value = recFilename;
		...
		$('#id_startStopRecordingBtn').val(M.str.assignment_babelium.babeliumStartRecording);
		//$('#id_viewRecordingExerciseBtn').val(M.str.assignment_babelium.babeliumViewExercise);
	...
	this.recordingAbortedListener = function() {
		...
		if(this.recordedFilename){
			//$('#id_viewRecordingExerciseBtn').val(M.str.assignment_babelium.babeliumViewRecording);
			//$('#id_viewRecordingExerciseBtn').show();
			$('#id_viewRecordingBtn').show();
			$('#id_viewExerciseBtn').show();
		}
	...
	*/
	...
	this.startStopRecordingClickHandler = function(){
		...
		if(this.bpPlayer.getState() == this.bpPlayerStates.RECORD_MIC_STATE || this.bpPlayer.getState() == this.bpPlayerStates.RECORD_BOTH_STATE){
			...
			$('#id_startStopRecordingBtn').val(M.str.assignment_babelium.babeliumStopRecording);
